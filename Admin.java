...
public class Admin {
    ...
    static void updateRequestStatus(String profId, String status) {
    ...
    static void regularPromote(File studentFolder, String currentSY, String nextSY) {

        File infoFile = new File(studentFolder, studentFolder.getName() + "_info.txt");
        List<String> enc = Utils.readFile(infoFile.getPath());
        if (enc.isEmpty())
            return;
        ...
        copyFolder(studentFolder, archiveDir);
        ...
        String updatedEnc = Utils.encryptEachField(String.join("|", p));
        Utils.writeRawFile(
                new File(newFolder, studentID + "_info.txt").getPath(),
                Collections.singletonList(updatedEnc));

        deleteFolder(studentFolder);
    }

    static void irregularPromote(File studentFolder,
            String currentSY,
            String targetSY,
            String targetYear) {
