...
public class StudentDashboardGUI extends JFrame {
    ...
    private void initUI() {
        ...
        tab1.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) { selectTab(tabs, tab1, 20, 70, "PROFILE"); }
        });
        tab2.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) { selectTab(tabs, tab2, 240, 90, "MESSAGE"); }
        });
        tab3.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) { selectTab(tabs, tab3, 460, 95, "SCHEDULE"); }
        });
        tab4.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) { selectTab(tabs, tab4, 680, 75, "GRADES"); }
        });
        tab5.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) { selectTab(tabs, tab5, 900, 165, "ACADEMIC"); }
        });
